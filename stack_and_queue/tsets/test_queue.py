...
def test_queue_enqueue_multiple_value(queue):
    queue = Queue()
    queue.enqueue(1)
    queue.enqueue(2)
    queue.enqueue(3)
...
def test_queue_dequeue_one_value(queue):
    queue = Queue()
    queue.enqueue(1)
    queue.enqueue(2)
    queue.enqueue(3)
...
def test_queue_dequeue_all_except_one(queue):
    first = queue.dequeue()
    sec = queue.dequeue()
...
def test_queue_dequeue_all(queue):
    first = queue.dequeue()
    sec = queue.dequeue()
    third = queue.dequeue()
